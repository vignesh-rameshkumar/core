...
const Footer = () => {
    ...
    return (
        <div className="bg-[#FFF] fixed bottom-0 h-[10%] w-full flex flex-col sm:flex-row justify-between items-center px-4 sm:px-15 shadow-md">
            <div className="flex flex-col sm:flex-row items-center mt-3 sm:mt-0">
                <p className="text-[#181D27]"> Designed 🎨 & Developed 👨🏻‍💻 by </p>
                <img
                    src={automation}
                    alt="Automation"
                    className="ml-2"
