...
const ModuleCard: React.FC<any> = ({ data }) => {
    return (
        <div className="w-full h-[300px] !rounded-lg bg-[#FDFDFD] " >
            ...
            <div className="w-full !h-[calc(280px-9%)] overflow-y-auto !rounded-lg grid grid-cols-2 md:grid-cols-3 gap-6 !p-6 mb-4">
